...
class Hostel(models.Model):
    ...
    genderType = models.BooleanField(default = 1) #1 means Male,0 Means Female
...
class IdCard(models.Model):
    ...
    facility = models.ForeignKey(Facility,null = True,blank = True) #The IdCard Facility
    pin = models.CharField(max_length = 8,null = True,blank = True)
    tshirtStatus = models.BooleanField(default = False)
